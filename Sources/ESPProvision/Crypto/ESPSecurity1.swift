...
class ESPSecurity1: ESPCodeable {
    ...
    private func generatePrivateKey() -> Data? {
        ...
        return CryptoKit.Curve25519.KeyAgreement.PrivateKey().rawRepresentation
    }
    ...
    private func generateKeyPair() {
        ...
        publicKey = try! CryptoKit.Curve25519.KeyAgreement.PrivateKey(rawRepresentation: privateKey).publicKey.rawRepresentation
    }
    ...
    private func processStep0Response(response: Data?) throws {
        ...
        do {
            var sharedKey: Data = try! CryptoKit.Curve25519.KeyAgreement.PrivateKey(rawRepresentation: privateKey!).sharedSecretFromKeyAgreement(with: Curve25519.KeyAgreement.PublicKey(rawRepresentation: devicePublicKey)).withUnsafeBytes({Data($0)})
